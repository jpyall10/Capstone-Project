...
//
//		Log.d("TAG", "the uri of the item is " + itemUri.toString());
//
...
//			if (cursorLabel_1 == null || cursorLabel_1.equals("")) {
...
//			} else {
//				editLabel_1.setHint(cursorLabel_1);
//				//if(editLabel_1.getText().toString().equals(cursorLabel_1))
//				//editLabel_1.setText(cursorLabel_1);
//				String enteredLabel_1 = editLabel_1.getText().toString();
//				if(enteredLabel_1 != null && enteredLabel_1.length()>0 && !enteredLabel_1.equals(cursorLabel_1)){
//					cv.put(ItemsContract.ItemsEntry.COLUMN_EXTRA_CARD_LABEL_1, enteredLabel_1);
//				}
...
//			if (cursorDescription_1 == null || cursorDescription_1.equals("")) {
...
//			} else {
//				editDescription_1.setHint(cursorDescription_1);
//				String enteredDescription_1 = editDescription_1.getText().toString();
//				if(enteredDescription_1 !=null && enteredDescription_1.length()>0 && !enteredDescription_1.equals(cursorDescription_1)){
//					cv.put(ItemsContract.ItemsEntry.COLUMN_EXTRA_CARD_DESCRIPTION_1, enteredDescription_1);
//				}
//			}
//			updated = getContentResolver().update(itemUri, cv, null, null);
